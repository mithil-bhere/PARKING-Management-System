...
<head>
    ...
    <title>PMS - View Vehicle Parking Details</title>
...
$ret=mysqli_query($con,"select tblregusers.FirstName,tblregusers.LastName,tblregusers.MobileNumber,tblregusers.Email,tblvehicle.ParkingNumber,tblvehicle.VehicleCategory,tblvehicle.VehicleCompanyname,tblvehicle.RegistrationNumber,tblvehicle.OwnerName,tblvehicle.ID as vehid,tblvehicle.OwnerContactNumber,tblvehicle.InTime,tblvehicle.OutTime,tblvehicle.location from tblvehicle join tblregusers on tblregusers.MobileNumber= tblvehicle.OwnerContactNumber where tblvehicle.OwnerContactNumber='$ownerno'");
$cnt=1;
